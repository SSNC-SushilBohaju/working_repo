...
public abstract class ProfileObject extends ElObject {
	...
	public void onNew() {
		super.onNew();
		Echonet.getEventListener().onNewProfileObject(this);
	}
...
/*
	@Override
	protected boolean onReceiveProperty(ElProperty property) {
	...
	private void onReceiveStatusChangeAnnouncementPropertyMap(byte[] edt) {
		byte[] properties = ElUtils.propertyMapToProperties(edt);
	...
	public static class Receiver extends ElObject.Receiver {
		 ...
		 * Get : optional<br>
		 */
		protected void onGetPlaceOfBusinessCode(ElObject eoj, short tid, byte esv, ElProperty property, boolean success) {}
		/**
		 * Specified in ASCII code<br>
		 * (Specified individually by each manufacturer)<br><br>
		 * Data type : unsigned char×12<br>
		 ...
		 * Get : optional<br>
		 */
		protected void onGetSerialNumber(ElObject eoj, short tid, byte esv, ElProperty property, boolean success) {}
		/**
		 * Stipulated in 4 bytes<br>
		 * YYMD (1 byte/character)<br>
		 * YY:Year (0x07CF for 1999)<br>M:Month (0x0C for 12)<br>
		 ...
		 * Get : optional<br>
		 */
		protected void onGetDateOfManufacture(ElObject eoj, short tid, byte esv, ElProperty property, boolean success) {}
		/**
		 * See “ECHONET Device Objects: Detailed Specifications”.<br><br>
		 * Data type : unsigned char×(MAX17)<br>
		 * Data size : Max.17<br>
		...
		protected void onGetStatusChangeAnnouncementPropertyMap(ElObject eoj, short tid, byte esv, ElProperty property, boolean success) {
			if(success) {
				byte[] properties = ElUtils.propertyMapToProperties(property.edt);
				for(byte p : properties) {
