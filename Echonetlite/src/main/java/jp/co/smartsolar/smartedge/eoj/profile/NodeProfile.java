package src.main.java.jp.co.smartsolar.smartedge.eoj.profile;
...
public abstract class NodeProfile extends ProfileObject {
	...
	public void onNew() {
		super.onNew();
		Echonet.getEventListener().onNewNodeProfile(this);
	}
	...
	protected byte[] getInstanceListNotification() {
		...
		return ElUtils.devicesToByteArray(getNode().getDevices(), 0);
	}
	...
	protected byte[] getSelfNodeInstanceListS() {
		...
		//ElUtils.devicesToByteArray(getNode().getDevices());
		return ElUtils.devicesToByteArray(getNode().getDevices(), 0);
	}
	...
	public static class Receiver extends ProfileObject.Receiver {
		...
		@Override
		protected boolean onInformProperty(ElObject eoj, short tid, byte esv,
				ElProperty property) {
		 ...
		 * Announcement at status change<br>
		 */
		protected void onSetOperatingStatus(ElObject eoj, short tid, byte esv, ElProperty property, boolean success) {}
		 ...
		 * Announcement at status change<br>
		 */
		protected void onGetOperatingStatus(ElObject eoj, short tid, byte esv, ElProperty property, boolean success) {}
		 ...
		 * Get : mandatory<br>
		 */
		protected void onGetVersionInformation(ElObject eoj, short tid, byte esv, ElProperty property, boolean success) {}
		 ...
		 * Get : optional<br>
		 */
		protected void onGetFaultContent(ElObject eoj, short tid, byte esv, ElProperty property, boolean success) {}
		 ...
		 * Get : mandatory<br>
		 */
		protected void onSetUniqueIdentifierData(ElObject eoj, short tid, byte esv, ElProperty property, boolean success) {}
		 ...
		 * Get : mandatory<br>
		 */
		protected void onGetUniqueIdentifierData(ElObject eoj, short tid, byte esv, ElProperty property, boolean success) {}
		 ...
		 * Get : mandatory<br>
		 */
		protected void onGetNumberOfSelfNodeInstances(ElObject eoj, short tid, byte esv, ElProperty property, boolean success) {}
		 ...
		 * Get : mandatory<br>
		 */
		protected void onGetNumberOfSelfNodeClasses(ElObject eoj, short tid, byte esv, ElProperty property, boolean success) {}
		 ...
		 * Announcement at status change<br>
		 */
		protected void onGetInstanceListNotification(ElObject eoj, short tid, byte esv, ElProperty property, boolean success) {
		}
		 ...
		 * Announcement at status change<br>
		 */
		protected void onInformInstanceListNotification(ElObject eoj, short tid, byte esv, ElProperty property) {}
		 ...
		 * Get : mandatory<br>
		 */
		protected void onGetSelfNodeInstanceListS(ElObject eoj, short tid, byte esv, ElProperty property, boolean success) {
		}
		 ...
		 * Get : mandatory<br>
		 */
		protected void onGetSelfNodeClassList(ElObject eoj, short tid, byte esv, ElProperty property, boolean success) {}
	}
	...
	public static class Informer extends ProfileObject.Informer {
		...
		//List<ElFrame> mNotificationFrameList = null;
		//ElObject mEoj;
	...
	public static class InformerC extends ElObject.InformerC {
