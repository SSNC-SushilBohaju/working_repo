package src.main.java.jp.co.smartsolar.smartedge.eoj.device.CurrentValueSensor;
...
public abstract class CurrentValueSensorClass extends DeviceObject {
	...
	public void onNew() {
		super.onNew();
		Echonet.getEventListener().onNewCurrentValueSensor(this);
	}
...
kWh<br>
		 ...
		 * Get - mandatory<br>
		 */
		protected void onGetIntegralElectricEnergyMeasurementValue(ElObject eoj, short tid, byte esv, ElProperty property, boolean success) {}
		/**
		 * Property name : Integral electric energy unit<br>
		 * <br>
		 * EPC : 0xE2<br>
		 ...
		 * Get - mandatory<br>
		 */
		protected void onGetIntegralElectricEnergyUnit(ElObject eoj, short tid, byte esv, ElProperty property, boolean success) {}
		/**
		 * Property name : Integral electric energy measurement log 1<br>
		 * <br>
		 * EPC : 0xE3<br>
...
kWh<br>
		 ...
		 * Get - optional<br>
		 */
		protected void onGetIntegralElectricEnergyMeasurementLog1(ElObject eoj, short tid, byte esv, ElProperty property, boolean success) {}
		/**
		 * Property name : Integral electric energy measurement log 2<br>
		 * <br>
		 * EPC : 0xE4<br>
...
kWh<br>
		 ...
		 * Get - optional<br>
		 */
		protected void onGetIntegralElectricEnergyMeasurementLog2(ElObject eoj, short tid, byte esv, ElProperty property, boolean success) {}
	}
...
kWh<br>
	...
	public static class Proxy extends CurrentValueSensorClass {
